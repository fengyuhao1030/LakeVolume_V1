rm(list = ls())
setwd('E:\\Lake Volume\\Lake Level\\ATL13_Ref_Compare')

compareMatrix <- read.csv('ATL_Ref_Compare.csv')
...
write.csv(resultMatrix,file = 'ATL_Ref_Compare_Change.csv',row.names = FALSE)